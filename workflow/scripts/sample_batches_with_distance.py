...
##############Counting Observered##############
## Will be in separate script for later
...
for i, sr in filter_df.iterrows():
    ...
    if anchor1_id not in anchor_slots:
        ...
        tmp_dist_df["anchor1_id_name"] = tmp_dist_df["chr1"]+"-"+tmp_dist_df["start1"].astype("str")+"-"+tmp_dist_df["end1"].astype("str")
    ...
    if anchor2_id not in anchor_slots:
        ...
        tmp_dist_df["anchor2_id_name"] = tmp_dist_df["chr2"]+"-"+tmp_dist_df["start2"].astype("str")+"-"+tmp_dist_df["end2"].astype("str")
